...
- hosted ChatGPT and Claude integration paths

The hosted side does not own campaign files, write local state, or decide the campaign for you.

## How to think about the split

If something depends on your campaign files, it belongs to the local workspace. If something depends on identity, local setup, or billing, it belongs to the hosted side.
