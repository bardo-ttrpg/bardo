...
Bardo writes a workspace MCP config that starts the local Bardo MCP server with `bardo mcp serve`. Keep this config in the project that owns the `.bardo/` prep layer.
