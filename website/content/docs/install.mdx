...
If you prefer npm, you can install the published package:

```bash
npm install -g @bardo/mcp
```

The curl and PowerShell installers are still the recommended setup path because they are the shortest route to the correct platform binary.
