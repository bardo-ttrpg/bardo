...
const rawDocsEntries = [
	...
	},
	{
		...
		navigationLabel: "Windsurf",
		eyebrow: "Get Started",
		group: "get-started",
		order: 9,
		sections: [
			{ id: "install-windsurf", title: "Install Windsurf" },
			{ id: "connect-bardo", title: "Connect Bardo" },
			{ id: "what-bardo-writes", title: "What Bardo writes" },
			{ id: "use-bardo-well-in-windsurf", title: "Use Bardo well in Windsurf" },
		],
		lastModified: "2026-04-29T00:00:00.000Z",
		load: () => import("@/content/docs/clients/windsurf.mdx"),
	},
	{
		slugSegments: ["clients", "kiro"],
		href: "/docs/clients/kiro",
		title: "Kiro",
		description:
			"Connect Bardo through Kiro's workspace MCP JSON and verify the local server from the same project.",
		navigationLabel: "Kiro",
		eyebrow: "Get Started",
		group: "get-started",
		order: 10,
		sections: [
			{ id: "install-kiro", title: "Install Kiro" },
			{ id: "connect-bardo", title: "Connect Bardo" },
			{ id: "what-bardo-writes", title: "What Bardo writes" },
			{ id: "use-bardo-well-in-kiro", title: "Use Bardo well in Kiro" },
		],
		lastModified: "2026-04-29T00:00:00.000Z",
		load: () => import("@/content/docs/clients/kiro.mdx"),
	},
	{
		slugSegments: ["clients", "kilo"],
	...
	},
	{
		...
		navigationLabel: "Trae",
		eyebrow: "Get Started",
		group: "get-started",
		order: 12,
		sections: [
			{ id: "install-trae", title: "Install Trae" },
			{ id: "connect-bardo", title: "Connect Bardo" },
			{ id: "what-bardo-writes", title: "What Bardo writes" },
			{ id: "use-bardo-well-in-trae", title: "Use Bardo well in Trae" },
		],
		lastModified: "2026-04-29T00:00:00.000Z",
		load: () => import("@/content/docs/clients/trae.mdx"),
	},
	{
