...
## Website billing setup (Clerk Billing)

Set these in `website/.env.local`:

```bash
NEXT_PUBLIC_APP_URL=http://127.0.0.1:3001
CLERK_BILLING_PLAN_SOLO=cplan_...
CLERK_BILLING_PLAN_SOLO_PLUS=cplan_...
CLERK_BILLING_PLAN_PARTY=cplan_...
```

Billing checkout and subscription management are rendered with Clerk's
experimental billing components in the pricing page.
